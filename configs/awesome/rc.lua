...
beautiful.get().wallpaper = os.getenv("HOME") .. "/.config/awesome/wallpaper.jpg"
beautiful.useless_gap = gapSize
...
-- Create Launcher Widget And Main Menu
myawesomemenu = {
	{
		"hotkeys",
		function()
...
-- Keyboard Map Indicator & Switcher
...
-- Custom Keys
	...
	end, { description = "launch rofi", group = "custom" }),
	...
	awful.key({ modkey }, "r", function()
		run_shell.launch()
	end, { description = "execute run shell", group = "layout" }),
...
-- Signal When New Client Appears
