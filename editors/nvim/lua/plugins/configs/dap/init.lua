...
for _, ft_path in ipairs(vim.api.nvim_get_runtime_file("lua/plugins/configs/dap/configs/*.lua", true)) do
	loadfile(ft_path)()
end
...
local hint = [[
 Nvim DAP
 _d_: Start/Continue  _j_: NextStep _k_: NextBreakpoint _l_: StepInto ^
